...
𝔩𝔬𝔯𝔢𝔫𝔷 = corruptphase(lorenz, rampInterval, (0.0, 0.2, 500.0, 1000.0))()

a = animatespectrum(𝔩𝔬𝔯𝔢𝔫𝔷, downsample=100, trail=2000, colorgradient=cgrad([:black, :crimson]), phasogram=true, nperseg=1000, dpi=100)
